          ...
          <div class="card-body">
            <form>
              <div class="form-group">
                <input type="text" class="form-control" id="nueva-pass" placeholder="Nueva Contraseña" required>
              </div>
              <br>
              <div class="form-group">
                <input type="password" class="form-control" id="repetir-nueva-pass" placeholder="Repetir Contraseña" required>
              </div>
              <br>
              <div class="form-group">
