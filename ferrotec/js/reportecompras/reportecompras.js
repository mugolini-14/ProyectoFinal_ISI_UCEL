...
//  Descripción: Valida los datos suministrados en el Reporte de Compras
...
$(document).ready(function() {
    ...
    //  Función:     $('#generar-reporte-compras').click(function()
    ...
    $('#generar-reporte-compras').click(function() {
        ...
        if(fechaInicio != '' && fechaFin != ''){
            ...
            if(fechaInicio != '' || fechaFin != ''){
                ...
                if((fechaInicio < fechaFin) || (fechaFin > fechaInicio)){
                    ...
                    $.ajax({
                        url: 'consultar_reporte_compras.php',
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            ...
                            <tr>
                                <td><b> Cantidad de Mercadería Comprada </b>: </td>
                                <td id="cantidad-articulos" class="cantidad-articulos"> ${data.suma_cant_art} unidades </td>
                            </tr>
                            <tr>
                                <td><b>Cantidad de Compras Realizadas (**)</b>: </td>
                                <td id="cantidad-compras" class="cantidad-compras"> ${data.suma_cant_compras} Compras </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td id="cantidad-compras-promedio-dia" class="cantidad-compras-promedio-dia"> ${data.suma_cant_compras_prom} Compras por día </td>
                            </tr>
                            <tr>
                                <td> <b> Cantidad de Unidades de Mercaderia Compradas Promedio por Día </b>:  </td>
                            ...
                            <tr>
                                <td colspan=2><b>(**)</b>:  Se computan todas las compras que contienen uno o varios artículos seleccionados, la compra es por cliente. </td>
                                <td> </td>
                            </tr>
    ...
    $('#descargar-reporte').click(function() {
       ...
       if(document.getElementById('fechageneracion')){     
            ...
            var cantidadCompras = document.querySelector('.cantidad-compras').innerHTML;
            var montoTotal = document.querySelector('.monto-total').innerHTML;
            var cantidadComprasPromedioDia = document.querySelector('.cantidad-compras-promedio-dia').innerHTML;
            ...
            console.log("cantidadCompras: " + cantidadCompras)
            console.log("montoTotal: " + montoTotal)
            console.log("cantidadComprasPromedioDia: " + cantidadComprasPromedioDia)
            ...
            formData.append('cantidadCompras', cantidadCompras);
            formData.append('montoTotal', montoTotal);
            formData.append('cantidadComprasPromedioDia', cantidadComprasPromedioDia);
            ...
            xhr.open("POST", "../reportecompras/generar_reporte_compras.php", true);
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    ...
                    link.download = 'reporte_compras_' + fechaHoraActual.getDate() + "-" + (fechaHoraActual.getMonth() + 1) + "-" + fechaHoraActual.getFullYear() 
