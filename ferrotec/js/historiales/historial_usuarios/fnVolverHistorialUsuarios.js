// Funcion: fnVolverHistorialUsuarios
// Descripción: Función que verifica si hay contenido en la página historial_usuarios.php, 
//              pregunta y valida si hay contenido y pregunta de volver al index.php, o
//              vuelve directamente al index.php

function fnVolverHistorialUsuarios(){
