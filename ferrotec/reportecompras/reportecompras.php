...
<body style="background-color: #f2f2f2">
            ...
            <div class="col-md-9 mt-5">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 style="float: left;">Reporte de Compras &nbsp;</h4>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col text-end">
                                                <button type="button" class="btn btn-success col-12" id="generar-reporte-compras">Generar Reporte</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- JS Propios -->
    <script src="../Js/reportecompras/reportecompras.js"></script>
