...
/*
    ...
    Descripción:    Arma el PDF con los resultados del Reporte de Compras
*/
    ...
    $cantidadCompras = $_POST['cantidadCompras'];
    $montoTotal = $_POST['montoTotal'];
    $cantidadComprasPromedioDia = $_POST['cantidadComprasPromedioDia'];
    ...
    $pdf->SetKeywords('Ferrotec, Reportes, Compras');
    ...
    "<html>
        <body>
            ...
            <br>
            <p style='float:left;'><b>Reporte de Compras</b></p>
            <br>".$fechaGeneracion."
            <br>
            <table>
                <tr>
        ...
        <body>
            ...
            <table>
                <tr>
                    ...
                    <td>".$cantidadComprasPromedioDia."</td>
                </tr>
                <tr>
    ...
    header('Content-Disposition: attachment; filename="reporte_compras_' . $fecha_reporte_archivo . '.pdf"');
    header('Cache-Control: max-age=0');

    // Grabar archivo con el reporte generado
    $pdf->Output('reporte_compras_' . $fecha_reporte_archivo . '.pdf', 'D');
