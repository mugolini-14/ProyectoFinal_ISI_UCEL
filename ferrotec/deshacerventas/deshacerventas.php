...
<body style="background-color: #f2f2f2">
            ...
            <div class="col-md-7 mt-5">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 style="float: left;">Deshacer Ventas &nbsp;</h4>
                    ...
                    <div class="card-body">
                        <form id="formulario-alta">
                            <div class="row md-12" id="seleccione">
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label class="col-form-label" for="iddeshacer">ID de venta a deshacer:</label>
                                    </div>
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="row py-2" id="fila-boton">
                                ...
                                <div class="col-4 text-center">
                                    <button onclick="fnDeshacerVentas()" type="button" class="btn btn-success col-12" id="deshacer-venta-btn">
                                        Deshacer venta
                                    </button>
                                </div>
    ...
    <!-- JS Propios -->
    <script src="../Js/deshacerventas/fndeshacerventa.js"></script>
