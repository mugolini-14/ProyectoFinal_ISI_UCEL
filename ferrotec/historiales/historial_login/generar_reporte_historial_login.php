<?php
/*
    PHP:            generar_reporte_historial_login.php
    Descripción:    Arma el PDF con los resultados del historial de login
*/
    ...
    $json_string = $_POST['JSON-historial-login'];
    ...
    foreach($filas as $row){
        $historial_fecha_registro = $row['fecharegistro'];
        $historial_tipo_actividad = $row['tipoactividad'];
        $historial_nombre_usuario = $row['usuarionombre'];
       
        $html_filas .=
        "<tr>
            <td>{$historial_fecha_registro}</td>
            <td>{$historial_tipo_actividad}</td>
            <td>{$historial_nombre_usuario}</td>
        </tr>
        ";
    } 
    ...
    $pdf->SetTitle('Historial de Actividad del Usuario');
    $pdf->SetSubject('Historial de Actividad del Usuario');
    $pdf->SetKeywords('Ferrotec, Historiales, Actividad');
    ...
    "<html>
        <body>
            ...
            <br>
                <p style='float:left;'> <b> Historial de Actividad del Usuario </b> </p>
    ...
    $pdf->Output('consulta_historial_login_' . $fecha_reporte_archivo . '.pdf', 'D');
