...
<html lang="en">
    ...
    <style>
        #tabla-body-cabecera-historial-tipos {
            display: block;
            overflow-x: auto;
        }

        #tabla-body-cabecera-historial-tipos tr {
            display: table;
            width: 100%;
            table-layout: fixed;
        }

        #tabla-body-historial-tipos {
            display: block;
    ...
    <body style="background-color: #f2f2f2">
                ...
                <div class="col-md-12 mt-5">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h4 style="float: left;">Historial de Tipos &nbsp;</h4>
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-select" id="tipo-accion">
                                                    ...
                                                    <option id="tipo-accion" value="alta_tipo"> Altas </option>
                                                    <option id="tipo-accion" value="baja_tipo"> Bajas </option>
                                                    <option id="tipo-accion" value="modif_tipo"> Modificaciones </option>
                                                </select>    
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row md-12">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <button onclick="fnConsultarHistorialTipos()" class="btn btn-primary col-12"> Consultar </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row md-12">
                                <table style="overflow-x: auto; overflow-y: auto;" class="table table-striped" id="tabla-body-cabecera-historial-tipos">
                                    ...
                                    <tbody class="table table-striped" id="tabla-body-historial-tipos" class="col md-12">
                            ...
                            <div class="row mt-12">
                                <div class="col-4">
                                    <button onclick="fnVolverHistorialTipos()" class="btn btn-primary col-12"> Volver </button>
                                </div>
                                <div class="col-4">
                                    <button onclick="fnGenerarReporteHistorialTipos()" class="btn btn-success col-12"> Generar Reporte </button>
                                </div>
                                <div class="col-4">
                                    <button onclick="fnLimpiarObjetosHistorialTipos()" class="btn btn-danger col-12"> Limpiar </button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- JS Propios -->
        <script src="../../js/historiales/historial_tipos/fnConsultarHistorialTipos.js"></script>
        <script src="../../js/historiales/historial_tipos/fnLimpiarObjetosHistorialTipos.js"> </script>
        <script src="../../js/historiales/historial_tipos/fnVolverHistorialTipos.js"> </script>
        <script src="../../js/historiales/historial_tipos/fnGenerarReporteHistorialTipos.js"> </script>
