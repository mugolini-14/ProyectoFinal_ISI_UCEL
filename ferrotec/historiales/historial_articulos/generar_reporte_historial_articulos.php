...
*/
    ...
    $json_string = $_POST['JSON-historial-articulos'];
    ...
    foreach($filas as $row){
        ...
        $historial_articulo = $row['articulo'];
        $historial_marca = $row['marca'];
        $historial_descripcion = $row['descripcion'];
        $historial_categoria = $row['categoria'];
        $historial_precio = $row['precio'];
        ...
        "<tr>
            ...
            <td>{$historial_articulo}</td>
            <td>{$historial_marca}</td>
            <td>{$historial_descripcion}</td>
            <td>{$historial_categoria}</td>
            <td>{$historial_precio}</td>
    ...
    "<html>
        <body>
            ...
            <br>
                <p style='float:left;'> <b> Historial de Artículos </b> </p>
    ...
    $pdf->Output('consulta_historial_articulos_' . $fecha_reporte_archivo . '.pdf', 'D');
